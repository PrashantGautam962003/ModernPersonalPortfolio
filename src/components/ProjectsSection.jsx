...
const projects = [
  {
    ...
    description: "A responsive admin dashboard with dark/light theming and modular UI components.",
  ...
  },
  {
    ...
    description:
      " Developed a full-stack property rental app using React.js mimicking Airbnb functionality.",
